...
--
```
　　　　# wget http://repo.mysql.com/mysql57-community-release-el7-10.noarch.rpm //获取官方yum包
...
　　　　　　msyql>  set global validate_password_length=1; //修改密码默认长度
